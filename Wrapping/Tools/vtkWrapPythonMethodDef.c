  ...
  FILE *fp, const char *classname, ClassInfo *data, int do_constructors)
{
  ...
  /* the python vtkObject needs a special InvokeEvent to turn any 
     classdata into an appropriately unwrapped void pointer */
  if (strcmp("vtkObject", data->Name) == 0 &&
      do_constructors == 0)
    {
    ...
    fprintf(fp,
              "PyvtkObject_InvokeEvent_s5(PyObject *self, PyObject *args)\n"
              "{\n"
              "  vtkPythonArgs ap(self, args, \"InvokeEvent\");\n"
              "  vtkObjectBase *vp = ap.GetSelfPointer(self, args);\n"
              "  vtkObject *op = static_cast<vtkObject *>(vp);\n"
              ...
              "\n"
              "static PyObject *\n"
              "PyvtkObject_InvokeEvent_s6(PyObject *self, PyObject *args)\n"
              "{\n"
              "  vtkPythonArgs ap(self, args, \"InvokeEvent\");\n"
              "  vtkObjectBase *vp = ap.GetSelfPointer(self, args);\n"
              "  vtkObject *op = static_cast<vtkObject *>(vp);\n"
    ...
    fprintf(fp,
              ...
              "\n"
              "static PyObject *\n"
              "PyvtkObject_InvokeEvent_s7(PyObject *self, PyObject *args)\n"
              "{\n"
              "  vtkPythonArgs ap(self, args, \"InvokeEvent\");\n"
              "  vtkObjectBase *vp = ap.GetSelfPointer(self, args);\n"
              "  vtkObject *op = static_cast<vtkObject *>(vp);\n"
              ...
              "   \"@z\"},\n"
              "  {NULL, PyvtkObject_InvokeEvent_s5, METH_VARARGS,\n"
              "   \"@Li\"},\n"
              "  {NULL, PyvtkObject_InvokeEvent_s6, METH_VARARGS,\n"
              "   \"@Ld\"},\n"
              "  {NULL, PyvtkObject_InvokeEvent_s7, METH_VARARGS,\n"
              "   \"@LV *vtkObjectBase\"}, \n"
              "  {NULL, NULL, 0, NULL}\n"
              "};\n"
              "\n"
